      ...
      <ScrollView style={styles.container}>
       <ImageBackground
          ...
          />							 
                <ListRow detail={
                <View style={styles.contentImput}>
                       <Button title={i18n.t('ACTION.login')} type='primary' disabled={!this.state.checkedEmpty}  style={{ margin: 2, width: 180, height: 50,backgroundColor:'#16424F',borderColor:'#16424F' }} size='lg' onPress={(e) => this._login(e)} />
                </View>
                } style={{ backgroundColor: 'rgba(178,178,178,0.0)' }} 
				bottomSeparator='none'
				/>
